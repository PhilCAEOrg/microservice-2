...
import i5.las2peer.services.restRes.database.DatabaseManager;
import java.sql.*;
...
@ServicePath("res")
@ManualDeployment
public class RestRes extends RESTService {
  ...
  @SwaggerDefinition(
      info = @Info(title = "2", version = "$Metadata_Version$",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-2/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final RestRes service = (RestRes) Context.getCurrent().getService();
